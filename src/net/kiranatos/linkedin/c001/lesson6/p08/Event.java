package net.kiranatos.linkedin.c001.lesson6.p08;
...
public class Event {
    ...
    public void incrementEventNumber()          { nextEventNumber++; }
    public String getEventNumber()              { return eventNumber; }
    public int getGuests()                      { return guests;    }
    public void setEventType(String value)      { eventType = value;    }
    public String getEventType()                { return eventType; }
    public double getTotal()                    { return guests*pricePerGuest; }
    public void setEventDate(String date)       { eventDate = date; }
    ...
    public void printEvent() {
        System.out.printf("\nYour event is for a %s\nEvent Number: %s" + "\nScheduled for: %s\nNumber of guests: %d" + "\nTotal cost $%6.2f", eventType, eventNumber, eventDate, +guests, getTotal());
        System.out.println();       
    }    
}