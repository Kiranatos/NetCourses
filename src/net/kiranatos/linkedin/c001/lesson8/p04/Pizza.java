package net.kiranatos.linkedin.c001.lesson8.p04;
...
public abstract class Pizza implements Comparable {
    ...
    public Pizza(int size)    {
        switch(size)        {
            case small_diameter:
                cost = price[0];size = small_diameter;
                break;
            case med_diameter:
                cost = price[1];size = med_diameter;
                break;
            case lg_diameter:
                cost = price[2];size = lg_diameter;
                break;
            case xlg_diameter:
                cost = price[3];size = xlg_diameter;
                break;
            default:
    ...
    public void printString()    {
        ...
        System.out.println("Your pizza has been ordered with: " + topping + " and \nThe total cost is: $" + cost);
    }
}