...
Hint: remember there are different types of the explicit locks available in Java.
Hint: for the import statements (as stated in the comment), please, 
start with the more generic import first (essentially sorted in the alphabetic order).
 */
